...
ARCHITECTURE structure OF latch_d_nor IS
...
\q$latch\ : maxii_lcell
-- Equation(s):
-- \q$latch~combout\ = ((GLOBAL(\enable~combout\) & ((\q$latch~combout\))) # (!GLOBAL(\enable~combout\) & (\din~combout\)))
...
-- Equation(s):
-- \qn$latch~combout\ = ((GLOBAL(\enable~combout\) & ((\qn$latch~combout\))) # (!GLOBAL(\enable~combout\) & (!\din~combout\)))
